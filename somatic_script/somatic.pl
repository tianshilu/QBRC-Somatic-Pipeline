...
# python (2), strelka (2.8.3, note: strelka is tuned to run exome-seq or RNA-seq), manta, java (1.8)
...
sub fun_strelka{
  ...
  system_call("configureStrelkaSomaticWorkflow.py --normalBam ".$normal_bam." --tumorBam ".$tumor_bam." --referenceFasta ".$index.
    " --runDir ".$output."/strelka ".$strelka_exome." --indelCandidates ".$output."/manta/results/variants/candidateSmallIndels.vcf.gz");
